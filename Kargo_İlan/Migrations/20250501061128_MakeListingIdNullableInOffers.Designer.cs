...
namespace Kargo_İlan.Migrations
{
    ...
    [Migration("20250501061128_MakeListingIdNullableInOffers")]
    partial class MakeListingIdNullableInOffers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kargo_İlan.Models.Listing", b =>
                {
                    ...
                    b.HasIndex(new[] { "CargoId" }, "IX_Listings_CargoId");
            ...
            modelBuilder.Entity("Kargo_İlan.Models.SystemSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Kargo_İlan.Models.Offer", b =>
                {
                    b.HasOne("Kargo_İlan.Models.Listing", "Listing")
                        .WithMany()
                        .HasForeignKey("ListingId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Kargo_İlan.Models.Listing", null)
                        .WithMany("Offers")
