...
namespace Kargo_İlan.Migrations
{
    ...
    [Migration("20250622174415_AddOfferStatus")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kargo_İlan.Models.Notification", b =>
                {
                    ...
                    b.Property<int?>("UserNotificationPrefId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserNotificationPrefId");
            ...
            modelBuilder.Entity("Kargo_İlan.Models.Offer", b =>
                {
                    ...
                    b.Property<int?>("OfferStatusStatusId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OfferStatusStatusId");
            ...
            modelBuilder.Entity("Kargo_İlan.Models.OfferStatus", b =>
                {
            ...
            modelBuilder.Entity("Kargo_İlan.Models.UserNotificationPrefs", b =>
                {
                    b.Property<int>("UserNotificationPrefId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("UserNotificationPrefId"));
                    ...
                    b.HasKey("UserNotificationPrefId");
                    ...
                    b.ToTable("UserNotificationPrefs", (string)null);
                });
            ...
            modelBuilder.Entity("Kargo_İlan.Models.Notification", b =>
                {
                    ...
                    b.HasOne("Kargo_İlan.Models.UserNotificationPrefs", "UserNotificationPref")
                        .WithMany()
                        .HasForeignKey("UserNotificationPrefId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("UserNotificationPref");
                });
            ...
            modelBuilder.Entity("Kargo_İlan.Models.Offer", b =>
                {
                    ...
                    b.HasOne("Kargo_İlan.Models.OfferStatus", null)
                        .WithMany("Offers")
                        .HasForeignKey("OfferStatusStatusId");
            ...
            modelBuilder.Entity("Kargo_İlan.Models.UserNotificationPrefs", b =>
                {
                    b.HasOne("Kargo_İlan.Models.User", "User")
                        .WithMany("NotificationPrefs")
                        .HasForeignKey("User_id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Kargo_İlan.Models.Province", "Varis_il")
                        .WithMany("VarisIlanlari")
                        .HasForeignKey("Varisil_id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Kargo_İlan.Models.District", b =>
                {
                    b.Navigation("VarisIlanlari");

                    b.Navigation("Varis_ilce");

                    b.Navigation("YuklemeIlanlari");
