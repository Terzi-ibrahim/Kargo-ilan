...
namespace Kargo_İlan.Migrations
{
    ...
    [Migration("20250506120534_InitialCreate")]
            ...
            modelBuilder.Entity("Kargo_İlan.Models.Freight", b =>
                {
                    ...
                    b.HasOne("Kargo_İlan.Models.District", null)
                        .WithMany("Yukleme_ilce")
                        .HasForeignKey("District_id");

                    b.HasOne("Kargo_İlan.Models.District", null)
                        .WithMany("Varis_ilce")
                        .HasForeignKey("District_id1");
                    ...
                    b.HasOne("Kargo_İlan.Models.Province", null)
                        .WithMany("Yukleme_il")
                        .HasForeignKey("Province_id");

                    b.HasOne("Kargo_İlan.Models.Province", null)
                        .WithMany("Varis_il")
                        .HasForeignKey("Province_id1");
            ...
            modelBuilder.Entity("Kargo_İlan.Models.UserRole", b =>
                {
                    ...
                    b.HasOne("Kargo_İlan.Models.Role", null)
                        .WithMany("UserRoles")
                    ...
                    b.HasOne("Kargo_İlan.Models.User", null)
                        .WithMany("UserRole")
